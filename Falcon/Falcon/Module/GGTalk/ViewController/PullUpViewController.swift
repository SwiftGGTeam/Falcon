...
//  Falcon
//
//  Created by Rickey on 2019/9/27.
//  Copyright © 2019 Harry Duan. All rights reserved.
//

import UIKit

// TODO: - 改写成 Protocol 形式？去掉继承
public class PullUpController<T: ViewModel>: FalcViewController<T> {
...
extension UIViewController {
     ...
     */
    open func addPullUpController<T: ViewModel>(_ pullUpController: PullUpController<T>,
     ...
     */
    open func removePullUpController<T: ViewModel>(_ pullUpController: PullUpController<T>, animated: Bool) {
...
extension UIScrollView {
     ...
     */
    open func attach<T: ViewModel>(to pullUpController: PullUpController<T>) {
     ...
     */
    open func detach<T: ViewModel>(from pullUpController: PullUpController<T>) {
